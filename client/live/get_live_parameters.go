...
// WithDefaults hydrates default values in the get live params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLiveParams) WithDefaults() *GetLiveParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get live params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLiveParams) SetDefaults() {
