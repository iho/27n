...
/* GetLiveOK describes a response with status code 200, with default header values.
...
func (o *GetLiveOK) Error() string {
	return fmt.Sprintf("[GET /live][%d] getLiveOK  %+v", 200, o.Payload)
}
func (o *GetLiveOK) GetPayload() []interface{} {
	return o.Payload
}
